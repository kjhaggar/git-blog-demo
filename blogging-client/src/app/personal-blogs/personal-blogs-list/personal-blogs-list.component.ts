...
@Component({
  selector: 'app-personal-blogs-list',
  templateUrl: './personal-blogs-list.component.html',
  styleUrls: ['./personal-blogs-list.component.css']
})
export class PersonalBlogsListComponent implements OnInit {
